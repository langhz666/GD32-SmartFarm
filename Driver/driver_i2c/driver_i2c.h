...
#define IIC_SCL_HIGH()              gpio_bit_set(GPIOB, GPIO_PIN_6)
#define IIC_SCL_LOW()               gpio_bit_reset(GPIOB, GPIO_PIN_6)

/* SDA数据线控制（开漏输出：输出高本质上是“释放”，由上拉拉高） */
#define IIC_SDA_HIGH()              gpio_bit_set(GPIOB, GPIO_PIN_7)
#define IIC_SDA_LOW()               gpio_bit_reset(GPIOB, GPIO_PIN_7)
